# Proposal
_This proposal presents a research concept focused on an activation timer designed to help college students with ADHD initiate tasks more effectively. Created for ENC 3241 – Writing for the Technical Professional, it serves as a sample demonstrating my ability to communicate a technical project clearly and professionally for academic and portfolio purposes.
_
...
_Step 3:_ Task Details: Each participant will complete two structured sessions: one using the activation timer and one using a standard Pomodoro‑style timer. In each session, participants will be asked to begin a small academic task they have been avoiding, such as outlining an assignment or organizing a weekly schedule. The goal is not to complete the task but to observe how quickly and comfortably they can start it under each timing condition. To avoid predictability and bias, the two timer conditions will be counterbalanced across participants. The participants will be split into two halves by random selection; with one half completing the activation‑timer condition first, and the other half completing the Pomodoro condition first. 

_Step 4:_ Data Collection and Measurement: During each session, I will collect both behavioral and self‑reported data. Behavioral measures include task initiation time (how long it takes the participant to begin working after opening the timer) and the number of small tasks completed.  To measure how mentally demanding each timer felt, participants will complete a simple 1–10 rating scale, where 1 means the task felt very easy and 10 means it felt very difficult/overwhelming. Participants will also answer brief questions about how easy or stressful it felt to start the task under each condition.

_Step 5:_ Qualitative Interviews and Feedback:  After completing both timer conditions (Pomodoro and the activation prototype), participants will take part in a brief semi‑structured interview about their experience. These interviews will ask how each timer made them feel, whether the interface reduced or increased overwhelm, and which system they preferred. With participant consent, responses will be recorded and later reviewed to identify recurring themes. 
...
3.	Kofler, Michael J., et al. “Working Memory and Inhibitory Control Deficits in Children with ADHD: An Experimental Evaluation of Competing Model Predictions.” Frontiers in Psychiatry, vol. 15, May 2024, p. 1277583. DOI.org (Crossref), https://doi.org/10.3389/fpsyt.2024.1277583.

4.	Le Cunff, Anne-Laure, et al. “Neurodiversity and Cognitive Load in Online Learning: A Focus Group Study.” PLOS ONE, edited by Claudia Brogna, vol. 19, no. 4, Apr. 2024, p. e0301932. DOI.org (Crossref), https://doi.org/10.1371/journal.pone.0301932.
